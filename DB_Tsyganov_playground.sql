...
CREATE SCHEMA IF NOT EXISTS `DB_Tsyganov_playground` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `DB_Tsyganov_playground` ;

-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`User`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`User` (
...
-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`Forum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`Forum` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NULL,
  ...
  CONSTRAINT `fk_Forum_User1`
    ...
    REFERENCES `DB_Tsyganov_playground`.`User` (`email`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`Thread`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`Thread` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATETIME NULL,
  ...
  CONSTRAINT `fk_Thread_Forum1`
    ...
    REFERENCES `DB_Tsyganov_playground`.`Forum` (`short_name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`Post`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`Post` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATETIME NULL,
  `message` TEXT NULL,
  `Forum_short_name` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `fk_Post_Thread1`
    FOREIGN KEY (`thread`)
    REFERENCES `DB_Tsyganov_playground`.`Thread` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`Followers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`Followers` (
...
-- -----------------------------------------------------
-- Table `DB_Tsyganov_playground`.`Subscriptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Tsyganov_playground`.`Subscriptions` (
  `User_email` VARCHAR(255) NOT NULL,
